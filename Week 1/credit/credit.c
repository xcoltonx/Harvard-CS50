...
int main(void)
{
    ...
    // test for valid number of digits
    ...
    // get each digit from the card number and put them into the checksum equation

    do
    {
        // add first digit to sum1 and reduce ccNUM by one digit

        digit1 = ccNUM % 10;
        ccNUM = ccNUM / 10;
        sum1 = sum1 + digit1;

        // add next digit to digit2 and reduce ccNUM by one digit

        digit2 = ccNUM % 10;
        ccNUM = ccNUM / 10;

        // double digit2 and take its
